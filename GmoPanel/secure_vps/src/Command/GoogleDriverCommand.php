...
class GoogleDriverCommand extends Command
{
    public function execute(Arguments $args, ConsoleIo $io)
    {
        ...
        $content = file_get_contents(WWW_ROOT.'ahihi.zip');
        printf('start: '.date('Y-m-d H:i:s'));
...
//            'mimeType' => 'application/x-rar-compressed, application/octet-stream',
    ...
    private function getClient()
    {
        ...
        $client->setApplicationName('SecureVps');
